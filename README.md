...
drugref.org is an open, vendor-independent drug-information service: a co-equal public good that any
EHR, pharmacy system, or app can consume, not a component bundled inside any one product. This repository
is the **global tier** — a registry of active drug moieties, each with an immortal identity and
