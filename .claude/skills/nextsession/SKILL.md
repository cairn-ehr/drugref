...
8. Before you start working, make sure that HANDOVER.md and ROADMAP.md represent the current state of progress and are up to date. If not, update them before you start working.
9. When you are done with your work, update HANDOVER.md and ROADMAP.md to reflect the current state of development and progress. Prune both documents to keep them concise and under 500 lines if possible. Focus on what still needs to be done, be very brief and summarize concisely on what has been done already. If you are not sure how to do this, ask me. Do NOT update CLAUDE.md as part of routine session wrap-up — it holds only stable, invariant context and changes only when a rule, command, or architecture invariant genuinely changes.
